...
public class HighScores {
     ...
     *
     * @return Map<Integer, String> with results and com.codecool.battleship.player names
     */
    ...
    /**
     * Checks if the com.codecool.battleship.player's score is a high score (top 10 of current high scores in highScores.txt).
     *
     * @param player - com.codecool.battleship.player that has won the game
     *
     */
