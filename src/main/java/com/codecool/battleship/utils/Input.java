...
import com.codecool.battleship.board.Direction;
...
public class Input {
    ...
    private Position getChosenCoordinates(String input) {
    ...
    public Position getPlacementSquare(Board board) {
        Position position;
        boolean isPlacementSquareInputCorrect;
        do {
            position = getShot();
            isPlacementSquareInputCorrect = board.canNewShipBeHere(position);
